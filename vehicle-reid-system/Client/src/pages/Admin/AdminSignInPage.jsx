  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (resolvedUser?.role !== "admin") {
        // Valid credentials, wrong portal — don't leave a non-admin
        // session sitting around from the admin sign-in page.
        logout();
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center px-6 py-12 sm:px-10">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm mb-8" style={{ color: "#4B617D" }}>
            ...
            <Link to="/admin/signup" className="font-semibold underline underline-offset-2" style={{ color: SAPPHIRE }}>
              Create one
            </Link>
          </p>
          ...
          <p className="mt-8 text-center text-[11px]" style={{ color: "#93A2B8" }}>
            This portal is for administrator accounts only. Operators should
